...
public interface Autenticador {
	 ...
	 * @param respuestaDesafio Respuesta al desafío
	 * @return usuario autenticado, si ésta tuvo éxito. null en caso de que no se
	 *         pueda autenticar al usuario por la razón que sea
	 */
